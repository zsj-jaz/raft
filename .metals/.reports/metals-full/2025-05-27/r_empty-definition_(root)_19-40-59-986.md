error id: file://<WORKSPACE>/src/main/scala/raft/FollowerBehavior.scala:`<none>`.
...
object FollowerBehavior {
  ...
  private def replicateLog(
    ...
    /** Because #3 dictates that you only truncate your log if you have conflicting entries, those
      ...
      *
      * my l@@og: [0, 1, 2, 3, 4, 5, 6], the 6th entry may not be the same as 6th entry in leader's
      * log,
      */
